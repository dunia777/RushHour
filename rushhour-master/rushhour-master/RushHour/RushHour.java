...
public class RushHour {
    ...
    try {
    	...
    	filename = "C:\\Users\\Dunia\\Documents\\AI\\assignment1\\input.txt";
    }
    
	Puzzle[] puzzles = Puzzle.readPuzzlesFromFile2(filename);
		...
		int[][] soln_depth = null;
		long[][] duration = null;
		System.out.println("num puzzles : "+num_puzzles);
